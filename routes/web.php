...
use App\Http\Controllers\Agent\AgentPropertyContoller;
...
Route::middleware(['auth','roles:admin'])->group(function(){
    ...
    Route::controller(PropertyController::class)->group(function(){
        ...
        Route::get('/property/multiimg/dalate/{id}', 'PropertyMultiimgDelete')->name('property.multiimg.dalate');
...
// -------------- Agent Grout Middleware ----------------------------------------------------
Route::middleware(['auth','roles:agent'])->group(function(){

    //agent all property
    Route::controller(AgentPropertyContoller::class)->group(function(){
        ...
        Route::get('/agent/edit/property/{id}', 'AgentEditProperty')->name('agent.edit.property');
         ...
         Route::get('/agent/property/multiimg/dalate/{id}', 'AgentPropertyMultiimgDelete')->name('agent.property.multiimg.dalate');
...
//Agent Details feontend page
Route::get('/agent/details/{id}', [IndexController::class, 'AgentDetails'])->name('agent.details');

// agent Message  Details Page
Route::post('/agent/details/message', [IndexController::class, 'AgentDetailsMessage'])->name('agent.details.message');

// all rent & buy property
