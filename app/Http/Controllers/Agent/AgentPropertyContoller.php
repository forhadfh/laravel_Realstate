...
class AgentPropertyContoller extends Controller
{
    ...
    public function AgentStoreProperty(Request $request){
        ...
        // End facility_name  Add from here//
    ...
    public function StoreBusinessPlan(Request $request){
        ...
        $notification = array(
            'message' => 'You have Purchase Bacis Package Successfully',
            'alert-type' => 'success',
        );
        return redirect()->route('agent.all.property')->with($notification); 
    } // End Mehood
    ...
    public function AgentMessageDetails($id){
        ...
        $msgdetails = PropertyMessage::findOrFail($uid);
