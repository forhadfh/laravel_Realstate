<template>
    ...
    <div>
        ...
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#chats">
         Chat Now
        </button>

        <!-- Modal -->
        <div class="modal fade" id="chats" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
