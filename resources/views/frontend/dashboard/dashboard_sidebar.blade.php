<div class="widget-content">
    <ul class="category-list ">
        ...
        <li><a href="{{ route('user.wishlist') }}"><i class="fa fa-indent" aria-hidden="true">
                </i> WishList <span class="badge badge-info" id="wishQty"> () </span></a></li>

        <li><a href="{{ route('live.chat') }}"><i class="fa fa-indent" aria-hidden="true">
                </i> Live Chat <span class="badge badge-info"></span></a></li>
