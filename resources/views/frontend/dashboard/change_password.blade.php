                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <form method="POST" action="{{ route('user.password.update') }}" class="default-form">
                                    @csrf

                                    <div class="form-group">
                                        <label>Old Password</label>
                                        <input type="password" name="old_password"
                                            class="form-control @error('old_password') is-endvalid @enderror "
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="new_password"
                                            class="form-control @error('new_password') is-endvalid @enderror "
