                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    ...
                                    <select name="state" class="form-select" id="exampleFormControlSelect1">
                                        ...
                                        @foreach($pstate as $stype)
                                        <option value="{{ $stype->id }}" {{ $stype->id == $property->state ?
                                            'selected' : '' }}>{{ $stype->state_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div><!-- Col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <select name="amenities_id[]" class="form-select js-example-basic-multiple "
                                        multiple="multiple" data-width="100%">

                                        @foreach($amenities as $ameni)

                                        <option value="{{ $ameni->amenitis_name }}" {{ (in_array($ameni->
                                            amenitis_name,$property_ami)) ?
                                            'selected' : '' }} >{{ $ameni->amenitis_name }}</option>
                                        @endforeach
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea name="short_descp" class="form-control" id="exampleFormControlTextarea1"
                                    rows="2">{{ $property->short_descp }}</textarea>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea name="long_descp" class="form-control" name="tinymce" id="tinymceExample"
                                    rows="3">{!! $property->long_descp !!}</textarea>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('agent.property.multiimg.dalate',$img->id) }}"
                        ...
                        <form method="post" action="{{ route('agent.store.new.multiimage') }}" id="myForm"
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="file" class="form-control" name="multi_img" required>
                                        </td>
                                        <td>
